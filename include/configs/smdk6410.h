...
#define CONFIG_ETHADDR		08:90:00:A0:90:90 //00:40:5c:26:0a:5b
...
//#define CONFIG_BOOTARGS    	"root=/dev/mtdblock3 rootfstype=yaffs2 console=ttySAC0,115200"
#define CONFIG_BOOTARGS    	"bootargs=root=/dev/nfs nfsroot=192.168.0.10:/forlinx/root/FileSystem-Yaffs2 ip=192.168.0.11:192.168.0.10:192.168.0.1:255.255.255.0 console=ttySAC0,115200"
...
#define CFG_MEMTEST_END		MEMORY_BASE_ADDRESS + 0xfc00000 /*0x7e00000		 128 MB in DRAM	*/
...
#define CONFIG_SYS_HZ			1562500		// at PCLK 50MHz
...
#define CONFIG_BOOTCOMMAND	"tftp 0x50008000 zImage;bootm 0x50008000"
//#define CONFIG_BOOTCOMMAND	"nand erase;fatload mmc 0:1 0x50008000 u-boot.bin;nand write.uboot 0x50008000 0 0x100000;fatload mmc 0:1 0x50008000 zImage;nand write.e    0x50008000 0x100000 0x500000; fatload mmc 0:1 0x50008000 rootfs.yaffs2; nand write.yaffs2 0x50008000 0x03800000 $filesize;  nand  ok "
#define CFG_MALLOC_LEN		(CFG_ENV_SIZE + 1024*1024)
#define CFG_ENV_SIZE		0x4000	/* Total Size of Environment Sector */
#define CFG_ENV_OFFSET		0x0003c000
